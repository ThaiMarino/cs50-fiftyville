...
WHERE year = 2021 AND month = 7 AND day = 28 AND atm_location = "Leggett Street";
    --commom suspects: Bruce, Luca, Iman, Diana
...
--that they were planning to take the earliest flight out of Fiftyville tomorrow. The thief then asked the person on the
...
LIMIT 1);
 --commom suspects: Bruce, Luca

--Phone Call
SELECT name FROM people
JOIN phone_calls ON phone_calls.caller = people.phone_number
WHERE year = 2021 AND month = 7 AND day = 28 AND duration < 60;
--commom suspect: Bruce
